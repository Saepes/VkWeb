...
function saveImg() {
	...
	<Panel id={id}>
		<PanelHeader left={<PanelHeaderBack onClick={go} data-to="choice"/>}>Регулярный сбор</PanelHeader>
		<Div>
...
<FormLayout>
		<Select onChange={setAuthor} top="Автор">
			<option value ="m">Матвей Правосудов</option>
			<option value ="a">Анонимно</option>
		</Select>
</FormLayout>
	<Div>
		<Button id = 'but' size="xl" style={styles.button} >Далее</Button>
	</Div>
	</Panel>
);
}
